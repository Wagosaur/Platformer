package Objects.Enemies 
{
	 ...
	 * 
	 */
	public class flyingSteve extends Physics
	{
		public var sprite:Image = new Image(Assets.OBJECT_FLYINGSTEVE);
		
		public var direction:Boolean = FP.choose(true, false);
		public var movement:Number = 2;
		
		public function flyingSteve(x:int, y:int) 
		{
			//set position      
			super(x, y);
			...
			graphic = sprite;
			mask = new Pixelmask(Assets.OBJECT_FLYINGSTEVE);
